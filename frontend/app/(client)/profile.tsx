...
const styles = StyleSheet.create({
  ...
  email: { fontSize: 14, color: '#b0b0b0', marginBottom: 12 },
  badge: {
  ...
  badgeText: { color: '#1a1a2e', fontSize: 12, fontWeight: 'bold' },
  ...
  infoLabel: { fontSize: 14, color: '#b0b0b0', marginLeft: 12, flex: 1 },
  ...
  logoutText: { color: '#ff4444', fontSize: 16, fontWeight: 'bold', marginLeft: 8 },
});
